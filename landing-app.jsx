        ...
        <div className="cj-two" style={{ marginTop: '2.5rem' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.3rem' }}>
            <p style={{ margin: 0, fontSize: 'var(--cj-t-body)', lineHeight: 'var(--cj-lh-body)', color: 'var(--cj-ink-soft)' }}>
              Desarrollamos espacios desde una mirada atravesada por el arte, la materialidad y la experiencia de habitar.
            </p>
            <p style={{ margin: 0, fontSize: 'var(--cj-t-body)', lineHeight: 'var(--cj-lh-body)', color: 'var(--cj-ink-soft)' }}>
              Desde 2020 desarrollamos proyectos de interiorismo y dirección creativa con base en Rosario, integrando arte, materialidad y oficios en cada espacio.
            </p>
            <p style={{ margin: 0, fontSize: 'var(--cj-t-body)', lineHeight: 'var(--cj-lh-body)', color: 'var(--cj-ink-soft)' }}>
            ...
            <div style={{ display: 'flex', gap: 40, marginTop: '0.6rem', flexWrap: 'wrap' }}>
              {[['2020', 'desde'], ['Rosario', 'base']].map(([n, l]) => (
                <div key={l}>
    ...
    <footer className="cj-site-footer" style={{ background: 'var(--cj-paper)', paddingTop: 'var(--cj-space-9)', paddingBottom: 'var(--cj-space-7)' }}>
      <Container>
        <div className="cj-footer">
          ...
          <FooterCol title="Contacto" items={[['Escribinos', WA_URL], [PHONE, TEL_URL], ['Solicitud de asesoramiento', '#contacto']]} />
        ...
        <div style={{ marginTop: 'var(--cj-space-8)', paddingTop: 'var(--cj-space-5)', borderTop: '1px solid var(--cj-line)', display: 'flex', justifyContent: 'space-between', gap: 16, flexWrap: 'wrap' }}>
          <span style={{ fontFamily: 'var(--cj-font-ui)', fontSize: 12, letterSpacing: '0.04em', color: 'var(--cj-text-subtle)' }}>© 2026 Casa Jaguar · Rosario, Argentina</span>
